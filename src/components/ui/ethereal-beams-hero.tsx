      ...
      <div className="relative z-10 flex min-h-screen items-center">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            {/* Subtitle */}
            <p className="mb-8 text-lg leading-8 text-white/70 sm:text-xl max-w-2xl mx-auto">
              Join thousands of players on the ultimate Minecraft network. Survival, SkyBlock, BedWars and more.
            </p>

            {/* Server IP with Copy */}
            <div className="flex items-center justify-center gap-3 mb-10">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 px-5 py-3">
                <span className="text-white/50 text-sm font-mono">IP</span>
                <span className="text-white font-mono font-semibold tracking-wide text-lg">{serverIP}</span>
                <button
                  onClick={copyIP}
            ...
            <p className="text-white/40 text-sm">
              Already a member?{" "}
              <a href="/register" className="text-white/80 hover:text-white underline underline-offset-4 transition-colors">
